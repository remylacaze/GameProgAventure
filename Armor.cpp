...
DynamicArray<std::string> Armor::names;
...
Armor::Armor(int level, int rarity) : Item(Item::Type::ARMOR, level, rarity)
{
...
Armor::Armor(int type, int defence, std::string name, int level, int buyValue, int sellValue, int rarity) : Item(Item::Type::ARMOR, name, level, buyValue, sellValue, rarity)
{
	this->type = type;
